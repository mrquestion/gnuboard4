...
function applyParagraph(val)
{
    for(var i = 0; i < parent.frames.length; i++) {
        if(parent.frames(i).name == window.name) {
            eval("parent.frames."+window.name+"." + paragraph.document.body.document.all.CHEditor.value).exec2("FormatBlock",val);
            return;
        }
    }
...
function insertHR (width, size, color, opt)
{
    ...
    for(var i = 0; i < parent.frames.length; i++) {
        if(parent.frames(i).name == window.name) {
            eval("parent.frames."+window.name+"." + horizontalRule.document.body.document.all.CHEditor.value).exec3(hr);
            return;
        }
    }
...
function viewZoom(val)
{
    for (var i=0; i < parent.frames.length; i++) {
        if (parent.frames(i).name == window.name) {
            eval("parent.frames."+window.name+"." + zoom.document.body.document.all.CHEditor.value).box_hide();
...
function run ()
{
    ...
    document.write("<tr>");
    document.write("<td title='인쇄'>" + obj.setIcon("print.gif", 26, 26, myobj + ".exec('Print',false)") + "</div></td>");
    document.write("<td title='실행 취소'>" + obj.setIcon("undo.gif", 26, 26, myobj + ".exec('Undo',false)") + "</div></td>");
    document.write("<td title='되살리기'>" + obj.setIcon("redo.gif", 26, 26, myobj + ".exec('Redo',false)") + "</div></td>");
    document.write("<td title='자르기'>" + obj.setIcon("cut.gif", 26, 26, myobj + ".exec('Cut',false)") + "</div></td>");
    document.write("<td title='복사'>" + obj.setIcon("copy.gif", 26, 26, myobj + ".exec('Copy',false)") + "</div></td>");
    document.write("<td title='붙이기'>" + obj.setIcon("paste.gif", 26, 26, myobj + ".exec('Paste',false)") + "</div></td>");
    document.write("<td title='전체 선택'>" + obj.setIcon("selectall.gif", 26, 26, myobj + ".exec('SelectAll',false)") + "</div></td>");
    ...
    document.write("<td>" + obj.setIcon("strike.gif", 26, 26, myobj + ".exec('Strikethrough',false)") + "</div></td>");
    document.write("<td>" + obj.setIcon("superscript.gif", 26, 26, myobj + ".exec('Superscript',false)") + "</div></td>");
    document.write("<td title='왼쪽 정렬'>" + obj.setIcon("subscript.gif", 26, 26, myobj + ".exec('Subscript',false)") + "</div></td>");
    ...
    document.write("<td title='양쪽 정렬'><div class=imagebutton>" + obj.setIcon("justifyfull.gif", 26, 26, myobj + ".exec('JustifyFull',false)") + "</div></td>");
    ...
    document.write("<td title='미디어'>" + obj.setIcon("media.gif", 26, 26, myobj + ".insert('media')") + "</div></td>");
    document.write("<td title='그림넣기'>" + obj.setIcon("image.gif", 26, 26, myobj + ".insert('image')") + "</div></td>");
    document.write("<td title='바탕 그림'>" + obj.setIcon("bgimage.gif", 26, 26, myobj + ".insert('bgimage')") + "</div></td>");
    document.write("<td title='표정 아이콘'>" + obj.setIcon("em.gif", 26, 26, myobj + ".insert('em')") + "</div></td>");

    if (this.IE) {
        document.write("<td title='특수 문자'>" + obj.setIcon("schar.gif", 26, 26, myobj + ".insertIE('schar')") + "</div></td>");
        document.write("<td title='본문 확대'>" + obj.setIcon("zoom.gif", 70, 26, myobj + ".displayWindow('zoom');windowPos(this,'zoom')",false) + "</div></td>");
        document.write("<td title='가로선'>" + obj.setIcon("hr.gif", 26, 26, myobj + ".displayWindow('horizontalRule');windowPos(this,'horizontalRule')",false) + "</div></td>");
        document.write("<td title='바탕색'>" + obj.setIcon("bgcolor.gif", 26, 26, myobj + ".setBackgroundColor()") + "</div></td>");
        ...
        document.write("<td>" + obj.setIcon("paragraph.gif", 58, 26, myobj + ".displayWindow('paragraph');windowPos(this,'paragraph')",false) + "</div></td>");
        ...
        document.write("<td>" + obj.setIcon("hr.gif", 26, 26, myobj + ".exec('InsertHorizontalRule',false)") + "</div></td>");
        document.write("<td>" + obj.setIcon("bgcolor.gif", 26, 26, myobj + ".insert('backcolor')") + "</div></td>");
        ...
        document.write("<td><select style='font-size:9pt' id='formatblock' onchange='"+myobj+".exec(\"FormatBlock\", this.options[selectedIndex].value)'>" +
    ...
    document.write("<td title='테이블 만들기'>" + obj.setIcon("table.gif", 26, 26, myobj + ".insert('table')") + "</div></td>");
    ...
    if (this.IE) {
        ...
        if (this.Preview)
            document.write("<input type=checkbox onclick='"+myobj+".previewMode()' id=chkPreviewMode name=chkPreviewMode><font style='font-size:9pt;'> 미리보기 &nbsp;</font>");
    }
    document.write("</td></tr></table>");
