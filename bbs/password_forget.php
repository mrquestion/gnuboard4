    ...
    <tr>
        <td height="50" align="center" valign="middle" bgcolor="#EBEBEB"><table width="590" height="40" border="0" cellspacing="0" cellpadding="0">
            <tr> 
                ...
                <td width="390" align="right" bgcolor="#FFFFFF" ><img src="<?=$g4[bbs_img_path]?>/step_01.gif" width="110" height="16"></td>
            </tr>
            </table></td>
    </tr>
</table>
...
<form name=fpasswordforget method=post action="javascript:fpasswordforget_submit(document.fpasswordforget);" autocomplete=off>
    <tr> 
        <td height="370" align="center" valign="top"><table width="540" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr> 
                <td width="540" height="115" align="center" valign="middle" background="<?=$g4[bbs_img_path]?>/dot_bg_img.gif"><table width="315" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                        <td width="15" height="40"><img src="<?=$g4[bbs_img_path]?>/icon_02.gif" width="6" height="6"></td>
                        <td width="300" colspan="2"><img src="<?=$g4[bbs_img_path]?>/text_title_01.gif" width="149" height="15"></td>
                    </tr>
                    <tr> 
            ...
            <tr>
                <td height="170" colspan="2" align="center" valign="middle" background="<?=$g4[bbs_img_path]?>/gray_bg_img.gif" bgcolor="#FFFFFF"><table width="315" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                        <td width="15" height="40"><img src="<?=$g4[bbs_img_path]?>/icon_02.gif" width="6" height="6"></td>
                        <td width="300" colspan="2"><img src="<?=$g4[bbs_img_path]?>/text_title_02.gif" width="139" height="15"></td>
                    </tr>
                    <tr> 
                        <td width="15" height="28"></td>
