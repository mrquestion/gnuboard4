...
if ($me_recv_mb_id) {
    ...
    $row = sql_fetch(" select me_memo from $g4[memo_table] where me_id = '$me_id' ");
    if ($row[me_memo]) 
    {
        $content = "\n\n\n>"
                 . "\n>"
...
<tr> 
    ...
    <td width="99" align="center" valign="middle"><a href="./memo.php?kind=recv"><img src="<?=$g4[bbs_img_path]?>/btn_recv_paper_off.gif" width="99" height="24" border="0"></a></td>
    <td width="2"  align="center" valign="middle">&nbsp;</td>
    <td width="99" align="center" valign="middle"><a href="./memo.php?kind=send"><img src="<?=$g4[bbs_img_path]?>/btn_send_paper_off.gif" width="99" height="24" border="0"></a></td>
    <td width="2"  align="center" valign="middle">&nbsp;</td>
    <td width="99" align="center" valign="middle"><a href="./memo_form.php"><img src="<?=$g4[bbs_img_path]?>/btn_write_paper_on.gif" width="99" height="24" border="0"></a></td>
...
<tr> 
    <td height="300" align="center" valign="top">
        ...
        <tr>
            <td height="200" align="center" valign="middle" bgcolor="#F6F6F6"><textarea name=me_memo rows=10 style='width:95%;' required itemname='내용'><?=$content?></textarea></td>
        </tr>
        </table></td>
</tr>
<tr> 
...
<tr>
    <td height="40" align="center" valign="bottom">
        <input id=btn_submit type=image src="<?=$g4[bbs_img_path]?>/btn_paper_send.gif" border=0>&nbsp;&nbsp;
