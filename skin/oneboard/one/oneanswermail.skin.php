<?
// 1:1 게시물 답변시 게시자에게 드리는 메일을 수정하고 싶으시다면 이 파일을 수정하십시오.
if (!defined("_GNUBOARD_")) exit; // 개별 페이지 접근 불가 
?>
<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=<?=$g4[charset]?>">
<title><?=$re_subject?></title>
</head>
        ...
        <tr>
            <td>
                ...
                <tr> 
                    ...
                    <td width="90%" bgcolor=#FBF7E7><?=$subject?></td>
                </tr>
                <!--
                <tr bgcolor="#FFFFFF"> 
                ...
                <tr> 
                    <td height="25" bgcolor=#F7F1D8>질문</td>
                ...
                <tr><td height="150" style="word-break:break-all;"><?=$one[on_question]?></td></tr>
                </table>
                <p>

                <table width="500" border="0" align="center" cellpadding="4" cellspacing="0">
                <tr><td height="150" style="word-break:break-all;"><?=$one[on_answer]?></td></tr>
                </table>
                <p>
