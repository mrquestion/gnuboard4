            ...
            <TD valign="middle" class=m_padding>
                ...
                <tr>
                    <td height="25">
                        ...
                        &nbsp;<a href="javascript:;" onclick="win_zip('fregisterform', 'mb_zip1', 'mb_zip2', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon');" align=absmiddle><img width="74" height="20" src="<?=$member_skin_path?>/img/post_search_btn.gif" border=0 align=absmiddle></a> -->
                        <input class=ed type=text name='mb_zip' size=6 maxlength=5 <?=$config[cf_req_addr]?'required':'';?> itemname='¿ìÆí¹øÈ£' value='<?=$member[mb_zip1].$member[mb_zip2]?>' style="vertical-align:middle">
