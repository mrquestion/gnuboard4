...
<tr>
    <td bgcolor="#CCCCCC">
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><INPUT class=m_text type=password name="mb_password" size=20 maxlength=20 <?=($w=="")?"required":"";?> itemname="ÆÐ½º¿öµå"></TD>
        </TR>
        <TR bgcolor="#FFFFFF">
            <TD class=m_title>ÆÐ½º¿öµå È®ÀÎ</TD>
            <TD class=m_padding><INPUT class=m_text type=password name="mb_password_re" size=20 maxlength=20 <?=($w=="")?"required":"";?> itemname="ÆÐ½º¿öµå È®ÀÎ"></TD>
        </TR>
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding>
                ...
                <tr>
                    <td class=m_padding2><input class=m_text type=text name="mb_password_q" size=55 required itemname="ÆÐ½º¿öµå ºÐ½Ç½Ã Áú¹®" value="<?=$member[mb_password_q]?>"></td>
                </tr>
                </table>
            </TD>
        </TR>
        <TR bgcolor="#FFFFFF">
            ...
            <TD class=m_padding><input class=m_text type=text name='mb_password_a' size=38 required itemname='ÆÐ½º¿öµå ºÐ½Ç½Ã ´äº¯' value='<?=$member[mb_password_a]?>'></TD>
        </TR>
        </TABLE>
    </td>
</tr>
    ...
    <td bgcolor="#CCCCCC">
        ...
        <? if ($w=="") { ?>
            <TR bgcolor="#FFFFFF">
                ...
                <TD class=m_padding><input class=m_text type=text id=mb_birth name='mb_birth' size=8 maxlength=8 minlength=8 required numeric itemname='»ý³â¿ùÀÏ' value='<?=$member[mb_birth]?>' readonly title='¿·ÀÇ ´Þ·Â ¾ÆÀÌÄÜÀ» Å¬¸¯ÇÏ¿© ³¯Â¥¸¦ ÀÔ·ÂÇÏ¼¼¿ä.'>
                    <a href="javascript:win_calendar('mb_birth', document.getElementById('mb_birth').value, '');"><img src='<?=$member_skin_path?>/img/calendar.gif' border=0 align=absmiddle title='´Þ·Â - ³¯Â¥¸¦ ¼±ÅÃÇÏ¼¼¿ä'></a></TD>
            </TR>
        <? } ?>
    ...
    <td bgcolor="#CCCCCC">
        ...
        <TR bgcolor="#FFFFFF">
            <td width="160" height="28" class=m_title>
                <?
                // ÀÌ¹ÌÁö »ý¼ºÀÌ °¡´ÉÇÑ °æ¿ì ÀÚµ¿µî·ÏÃ¼Å©ÄÚµå¸¦ ÀÌ¹ÌÁö·Î ¸¸µç´Ù.
                if (function_exists("imagecreate")) {
                    echo "<img src='$g4[bbs_path]/norobot_image.php?{$g4['server_time']}' border='0'>";
                    $norobot_msg = "* ¿ÞÂÊÀÇ ÀÚµ¿µî·Ï¹æÁö ÄÚµå¸¦ ÀÔ·ÂÇÏ¼¼¿ä.";
                }
                else {
                    echo $norobot_str;
                    $norobot_msg = "* ¿ÞÂÊÀÇ ±ÛÀÚÁß <FONT COLOR='red'>»¡°£±ÛÀÚ</font>¸¸ ¼ø¼­´ë·Î ÀÔ·ÂÇÏ¼¼¿ä.";
                }
                ?>
            </td>
            <td class=m_padding>
