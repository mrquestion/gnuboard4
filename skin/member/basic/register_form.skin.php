    ...
    <td bgcolor="#CCCCCC">
        ...
        <? if ($w=="") { ?>
            <TR bgcolor="#FFFFFF">
                ...
                <TD class=m_padding><input class=ed type=text id=mb_birth name='mb_birth' size=8 maxlength=8 minlength=8 required numeric itemname='»ý³â¿ùÀÏ' value='<?=$member[mb_birth]?>' readonly title='¿·ÀÇ ´Þ·Â ¾ÆÀÌÄÜÀ» Å¬¸¯ÇÏ¿© ³¯Â¥¸¦ ÀÔ·ÂÇÏ¼¼¿ä.'>
