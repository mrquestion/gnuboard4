...
<tr>
    <td bgcolor="#CCCCCC">
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <td class=m_padding><input class=m_text type=text name='wr_key' required itemname='ÀÚµ¿µî·Ï¹æÁö' size=15>&nbsp;&nbsp;* ¿ÞÂÊÀÇ ±ÛÀÚÁß <FONT COLOR="red">»¡°£±ÛÀÚ</font>¸¸ ¼ø¼­´ë·Î ÀÔ·ÂÇÏ¼¼¿ä.</td>
        </tr>
        </table>
    </td>
</tr>
