...
<tr><td align=right><a href="javascript:comment_box('', 'c');" title="코멘트수정, 답변을 클릭하면 코멘트입력이 사라집니다. 코멘트입력으로 원위치하는 경우에 클릭하십시오."><span class=small style='color:silver;'>코멘트입력</span></a></td>
</tr></table>
