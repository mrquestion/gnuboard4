...
<tr><td height=30 bgcolor=#F8F8F9 style="padding:5 0 5 0;">&nbsp;&nbsp;<strong><? if ($is_category) { echo ($category_name ? "[$view[ca_name]] " : ""); } ?><?=cut_hangul_last($view[wr_subject])?></strong></td></tr>
...
<? 
if ($prev_href) {
    echo "<tr><td colspan=3 height=1 bgcolor=silver></td></tr>";
    echo "<tr><td colspan=3 height=25 style='padding-left:10px;word-break:break-all;' class=lh>";
    echo "<font color=gray>이전글 ▲ :</font> <a href=\"$prev_href\">$prev_wr_subject</a>&nbsp;";
    echo "</td></tr>";
}
...
if ($next_href) {
    echo "<tr><td colspan=3 height=1 bgcolor=silver></td></tr>";
    echo "<tr><td colspan=3 height=25 style='padding-left:10px;word-break:break-all;' class=lh>";
    echo "<font color=gray>다음글 ▼ :</font> <a href=\"$next_href\">$next_wr_subject</a>&nbsp;";
    echo "</td></tr>";
}
?>
<tr><td colspan=3 height=1 bgcolor=#B0ADF5></td>
</table><br>
