...
<img src='./img/icon_title.gif'> <span class=title><?=$html_title?></span>
<p>
...
<p>받는 메일주소 : <input type=text class=input name=mail size=40 required itemname="E-mail" value="<?=$member[mb_email]?>">
<input type=submit value=" 발 송 ">
</form>
